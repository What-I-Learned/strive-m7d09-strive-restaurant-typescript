...
import { PastaMenuJSON } from "../typings/MenuJSON";
...
function Home({ title }: HomeProps) {
  const [selected, setSelected] = useState<PastaMenuJSON | null>(null);

  const tsDishes: PastaMenuJSON[] = dishes;
  console.log(tsDishes);
